...
<span style="font-size: 1vw; width: 100%;">
    **Interested in creating a similar project?** This dashboard was designed by [Lucas Okwudishu](https://www.lokwudishu.com/){:target="_blank"} following a tutorial by [Melissa Van Bussel](https://www.melissavanbussel.com/){:target="_blank"}. You can access the source code for this dashboard [here](https://github.com/LucasO21/spotify-dashboard){:target="_blank"}.
    
<br>
    
Discover the original dashboard by Melissa Van Bussel [here](https://melissavanbussel.github.io/spotify-dashboard){:target="_blank"} and view her source code [here](https://github.com/melissavanbussel/spotify-dashboard){:target="_blank"}.
     
<br>

Learn more about [Posit's 2024 Table Contest](https://posit.co/blog/announcing-the-2024-table-contest/){:target="_blank"}. 
